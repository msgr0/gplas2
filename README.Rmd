...
3. Plasflow is present in the conda environment. 
4. mlplasmids is present in the conda environment 
...
```{bash, eval = FALSE}
./gplas.sh -i mygraph.gfa -o foldername -n mlplasmidsftw -s 'Enterococcus faecium' -t 0.7 -x 10
```
