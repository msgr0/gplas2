...
-   [Main output files](#main-output-files)
    ...
    -   [plasmidome\_network.png](#plasmidome_network.png)
    -   [components.fasta](#components.fasta)
-   [Help page](#help-page)
...
-   *-i*: Path to the graph file in \*.gfa format used to extract nodes
    and links. Gfa file format
...
-   *-t*: Threshold to predict plasmid-derived sequences. Integer value
...
-   *-m*: Mode to run gplas: ‘normal’ or ‘bold’. Bold mode increases the
    acceptance of connections to enlogate the path. String value.
    Default: ‘normal’
