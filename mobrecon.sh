...
echo -e "\n"
echo -e "!!!!!!Welcome to the script to run and evaluate mob_recon!!!!!!\n"
...
then
  ...
  echo -e "You have given a reference genome to evaluate the results of mobrecon:" $reference
...
snakemake --use-conda  -s mob.smk mobrecon/"$name"_completeness.tab
